...
import mentorshipimg from "../../image/mentorshipimg.jpg"

function Mentorship() {
  return (
    <div>
        <div className='mentorship-bg'>
            <Otherpage title="Mentorship Package" /> 
        </div>
            ...
            <div className='container'>
                <div className='innerbackground'>
                    <div className='service-content'>
                        ...
                        <NavLink to="/get_started" className="booknow-nav">Book Now</NavLink>
                        </div>
                    </div>

                    <div className='service-img'>
                    <img src={mentorshipimg} alt="services" />
                    </div>
